      ...
      *  PRINT THE DEPT-GROUP-LINE, TO CLASS-GROUP-LINE, AND
      ...
      *
       01  STUDENT-RECORD.
           ...
           05  SR-NAME                         PIC X(20).
           05  SR-TEST-ARRAY OCCURS 4 TIMES    PIC 9(3).
      ...
      *
       01  DETAIL-LINE.
           ...
           05  DL-NAME                     PIC X(20).
           05                              PIC X(7).
           05  DL-TEST-ARRAY OCCURS 4 TIMES PIC ZZ9BBBBB.
           05  DL-GRADE                    PIC X.
      ...
      *  CHECK FOR CONTROL BREAKS HERE
             ...
             EVALUATE TRUE
                   ...
                   WHEN SR-DEPT-CODE NOT = DF-DEPT-HOLD
                       PERFORM 700-DEPT-BREAK
                       PERFORM 450-PRINT-DEPT-HEADER
                       PERFORM 475-PRINT-CLASS-HEADER
                   WHEN SR-CLASS-CODE NOT = DF-CLASS-HOLD
           ...
           MOVE SR-TEST-ARRAY(SUB) TO DL-TEST-ARRAY(SUB)
           ADD SR-TEST-ARRAY(SUB) TO DF-TEST-TOTAL
